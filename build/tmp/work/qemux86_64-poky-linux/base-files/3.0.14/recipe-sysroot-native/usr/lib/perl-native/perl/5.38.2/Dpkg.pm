...
our $PROGVERSION = '1.22.0-dirty';
our $PROGMAKE = 'make';
our $PROGTAR = 'tar';
our $PROGPATCH = 'patch';

our $CONFDIR = '/kitchen/build/tmp/work/qemux86_64-poky-linux/base-files/3.0.14/recipe-sysroot-native/etc/dpkg';
our $ADMINDIR = '/kitchen/build/tmp/work/qemux86_64-poky-linux/base-files/3.0.14/recipe-sysroot-native/var/lib/dpkg';
our $LIBDIR = '/kitchen/build/tmp/work/qemux86_64-poky-linux/base-files/3.0.14/recipe-sysroot-native/usr/libexec/dpkg';
our $DATADIR = '/kitchen/build/tmp/work/qemux86_64-poky-linux/base-files/3.0.14/recipe-sysroot-native/usr/share/dpkg';
